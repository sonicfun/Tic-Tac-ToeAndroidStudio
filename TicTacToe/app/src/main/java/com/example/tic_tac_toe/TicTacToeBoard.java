...
//This is the board of the game, with all the features of the game.
class TicTacToeBoard extends View {
    ...
    private  void drawWinningLine(Canvas canvas){
     ...
     public void setUpGame( Button playAgain, Button home,Button statistic ,TextView playerDisplay, String[] names){
                game.setPlayAgainBTN(playAgain);
                game.setHomeBTN(home);
                game.setStatisticBTN(statistic);
